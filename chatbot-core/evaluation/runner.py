...
def get_chatbot():
    ...
    try:
        ...
        class ActualChatbot:
            def get_response(self, question: str, expected_answer: str, 
                           ground_truth_context: str) -> Dict[str, str]:
...
@pytest.fixture(scope="session")
def sampled_questions(golden_dataset):
...
@pytest.fixture(scope="session")
def evaluation_results(sampled_questions, chatbot, evaluation_metrics):
    """
